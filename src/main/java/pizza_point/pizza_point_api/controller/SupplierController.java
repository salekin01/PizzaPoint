...
public class SupplierController {
    ...
    public int create(@RequestBody Supplier body){
        try {
            supplierRepository.sp_supplier_create(body.getSupplierName(), body.getAddress(), body.getCity(), body.getPostalCode(), body.getPhone(),body.getEmail(),body.getHidden());
            return 1;
        }
        catch (Exception e){
            return 0;
    ...
    public int update(@RequestBody Supplier body){
        try {
            supplierRepository.sp_supplier_update(body.getSupplierId(), body.getSupplierName(), body.getAddress(), body.getCity(), body.getPostalCode(), body.getPhone(),body.getEmail(), body.getHidden());
            return 1;
        }
        catch (Exception e){
            return 0;
    ...
    public int delete(@PathVariable String id){
        try {
            long p_id = Long.parseLong(id);
            supplierRepository.sp_supplier_delete(p_id);
            return 1;
        }
        catch (Exception e){
            return 0;
